...
sudo apt install apache2 curl mariadb-server php-zip zip php-curl php-mysql tree mc vim libapache2-mod-php python3-distutils unzip wget w3m build-essential -y 
